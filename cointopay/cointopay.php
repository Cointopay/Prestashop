...
class Cointopay extends PaymentModule
{
    ...
    protected function getConfigFormValues()
    {
        ...
        return ['COINTOPAY_DISPLAY_NAME' => $dislay_name, 'COINTOPAY_MERCHANT_ID' => Configuration::get('COINTOPAY_MERCHANT_ID'), 'COINTOPAY_SECURITY_CODE' => Configuration::get('COINTOPAY_SECURITY_CODE'), 'COINTOPAY_CRYPTO_CURRENCY' => Configuration::get('COINTOPAY_CRYPTO_CURRENCY')];
    }
